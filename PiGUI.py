...
#---------------------------
def classtask():
    webbrowser.get(Chrome).open_new("https://task.data.techcollege.dk/home")    

def office():
    webbrowser.get(Chrome).open_new("https://www.office.com/create?auth=2")    

def studie():
    webbrowser.get(Chrome).open_new("https://all.studieplus.dk/")    
...
#-------box 5-------
box5 = Box(window5, align="left", width="fill", border=2)
...
classtask1 = PushButton (box5, image = "globe.png", align="bottom", command=classtask)

office1 = PushButton (box5, image = "office.png", align="bottom", command=office)

studie1 = PushButton (box5, image = "", align="bottom", command=studie)
#-------vindue4-----------
...
#--------------------
classtask1.height=175
classtask1.width=175
